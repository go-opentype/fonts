...
//
// Noto Sans JP is a variable font upstream; the bundled .ttf is pinned at its
...
//
// Importing this package links only Noto Sans JP into your binary. No other
// bundled family is compiled in unless you import its package too.
package notosansjp

import _ "embed" // for the //go:embed directive below

// TTF holds the raw TrueType bytes of Noto Sans JP, ready for opentype.Parse.
//
