...
//
// License: OFL-1.1. Copyright 2014 The Nunito Project Authors (https://github.com/googlefonts/nunito)
// Upstream: https://github.com/google/fonts/tree/main/ofl/nunito
//
// Nunito is a variable font upstream; the bundled .ttf is pinned at its
...
//
// Importing this package links only Nunito into your binary. No other
// bundled family is compiled in unless you import its package too.
package nunito

import _ "embed" // for the //go:embed directive below

// TTF holds the raw TrueType bytes of Nunito, ready for opentype.Parse.
//
//go:embed nunito.ttf
var TTF []byte
