...
//
// License: OFL-1.1. Copyright 2016 The Mulish Project Authors (https://github.com/googlefonts/mulish)
// Upstream: https://github.com/google/fonts/tree/main/ofl/mulish
//
// Mulish is a variable font upstream; the bundled .ttf is pinned at its
...
//
// Importing this package links only Mulish into your binary. No other
// bundled family is compiled in unless you import its package too.
package mulish

import _ "embed" // for the //go:embed directive below

// TTF holds the raw TrueType bytes of Mulish, ready for opentype.Parse.
//
//go:embed mulish.ttf
var TTF []byte
