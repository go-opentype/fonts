...
//
// License: OFL-1.1. Copyright 2015 The Rubik Project Authors (https://github.com/googlefonts/rubik)
// Upstream: https://github.com/google/fonts/tree/main/ofl/rubik
//
// Rubik is a variable font upstream; the bundled .ttf is pinned at its
...
//
// Importing this package links only Rubik into your binary. No other
// bundled family is compiled in unless you import its package too.
package rubik

import _ "embed" // for the //go:embed directive below

// TTF holds the raw TrueType bytes of Rubik, ready for opentype.Parse.
//
//go:embed rubik.ttf
var TTF []byte
