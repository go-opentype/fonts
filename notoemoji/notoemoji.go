...
// Package notoemoji embeds Noto Emoji, a variable font upstream (bundled at its default master).
//
// License: OFL-1.1. Copyright 2013 Google LLC
// Upstream: https://github.com/google/fonts/tree/main/ofl/notoemoji
//
// Noto Emoji is a variable font upstream; the bundled .ttf is pinned at its
...
//
// Importing this package links only Noto Emoji into your binary. No other
// bundled family is compiled in unless you import its package too.
package notoemoji

import _ "embed" // for the //go:embed directive below

// TTF holds the raw TrueType bytes of Noto Emoji, ready for opentype.Parse.
//
